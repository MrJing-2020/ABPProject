(function () {
    $(function () {
        var app = new Vue({
            ...
            data: {
                formItem: {},
                abpService: abp.services.app.client,
                deleteId: null
            },
            ...
            methods: {
                ...
                getClientById: function (id) {
                    ...
                    that.abpService.getClientById(postData).done(function (res) {
                        that.formItem = res;
                    }).always(function () {
                ...
                subFormData: function (e) {
                    ...
                    abp.ui.setBusy($("#vue-app"));
                    this.abpService.editClient(postData).done(function () {
                ...
                deleteItem: function (params) {
                    ...
                    abp.ui.setBusy($("#vue-app"));
                    that.abpService.deleteClient(postData).done(function (res) {
                        params.callBack();
                    }).always(function () {
                        abp.ui.clearBusy($("#vue-app"));
